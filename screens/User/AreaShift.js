                ...
                </TouchableOpacity>
                {
                    ...
                    <View style={shared.flexCenter}>
                        <TouchableOpacity onPress={() => this.chooseTime(option.id, 1)}>
                            <BoldText style={[fonts.size22,{color: Colors.secColor}]}>{option.time1}</BoldText>
                        </TouchableOpacity>
                        <BoldText style={{color: 'black'}}> - </BoldText>
                        <TouchableOpacity onPress={() => this.chooseTime(option.id, 2)}>
                            <BoldText style={[fonts.size22,{color: Colors.secColor}]}>{option.time2}</BoldText>
                        </TouchableOpacity>
                    </View>
                    :
                    <View>
                        <BoldText style={[fonts.size22, {color: '#d3d3d3'}]}>{option.time1 + ' - ' + option.time2}</BoldText>
                    </View>
                }
            </View>
        })
