                        ...
                        >
                            <View style={{flex: 1, paddingHorizontal: normalize(20)}}>
                                    ...
                                    <View style={this.state.insuranceImageError ? [styles.licenseImg, styles.error] : styles.licenseImg}>
                                        {
                                            ...
                                            <Image source={{uri: this.state.insuranceImage}} style={{width: '100%', height: '100%'}} resizeMode="stretch" />
                                            :
                                ...
                                <View style={this.state.anyImageError ? [styles.licenseImg, styles.error] : styles.licenseImg}>
                                    {
                                        this.state.anyImage ?
                                        <Image source={{uri: this.state.anyImage}} style={{width: '100%', height: '100%'}} resizeMode="stretch" />
                                        :
